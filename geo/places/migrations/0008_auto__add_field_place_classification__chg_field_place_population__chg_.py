...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.classification'
        db.add_column(u'places_place', 'classification',
                      self.gf('django.db.models.fields.CharField')(default='city', max_length=20),
                      keep_default=False)


        # Changing field 'Place.population'
        db.alter_column(u'places_place', 'population', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Place.elevation'
        db.alter_column(u'places_place', 'elevation', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Place.classification'
        db.delete_column(u'places_place', 'classification')


        # Changing field 'Place.population'
        db.alter_column(u'places_place', 'population', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Place.elevation'
        db.alter_column(u'places_place', 'elevation', self.gf('django.db.models.fields.IntegerField')())
