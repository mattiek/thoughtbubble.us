...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'location_location', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='', unique_with=('organization',), max_length=50, populate_from='name'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.slug'
        db.delete_column(u'location_location', 'slug')
    ...
    models = {
        ...
        u'location.location': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': "('organization',)", 'max_length': '50', 'populate_from': "'name'"}),
