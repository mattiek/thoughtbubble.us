...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.sherlock_description'
        db.add_column(u'location_location', 'sherlock_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.sherlock_description'
        db.delete_column(u'location_location', 'sherlock_description')
