...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationImage.active'
        db.add_column(u'location_locationimage', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationImage.active'
        db.delete_column(u'location_locationimage', 'active')
