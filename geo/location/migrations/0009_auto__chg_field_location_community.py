...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.community'
        db.alter_column(u'location_location', 'community_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['community.Community'], null=True))

    def backwards(self, orm):

        # Changing field 'Location.community'
        db.alter_column(u'location_location', 'community_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['neighborhood.Neighborhood'], null=True))
    ...
    models = {
        ...
        u'location.location': {
            ...
            'community': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['community.Community']", 'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
