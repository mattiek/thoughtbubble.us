...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationImage.ordering'
        db.add_column(u'location_locationimage', 'ordering',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationImage.ordering'
        db.delete_column(u'location_locationimage', 'ordering')
