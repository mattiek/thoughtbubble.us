...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'location_location', 'community_id')

        # Adding field 'Location.organization'
        db.add_column(u'location_location', 'organization',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'location_location', 'community',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['community.Community'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Location.organization'
        db.delete_column(u'location_location', 'organization_id')
