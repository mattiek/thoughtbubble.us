...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field curators on 'Organization'
        m2m_table_name = db.shorten_name(u'organization_organization_curators')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field curators on 'Organization'
        db.delete_table(db.shorten_name(u'organization_organization_curators'))
