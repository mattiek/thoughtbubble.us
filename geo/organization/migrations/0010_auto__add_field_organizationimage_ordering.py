...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganizationImage.ordering'
        db.add_column(u'organization_organizationimage', 'ordering',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganizationImage.ordering'
        db.delete_column(u'organization_organizationimage', 'ordering')
