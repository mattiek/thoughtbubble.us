...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organization.place'
        db.add_column(u'organization_organization', 'place',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Organization.place'
        db.delete_column(u'organization_organization', 'place_id')
