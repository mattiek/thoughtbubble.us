...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'organization_organization', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='', unique_with=('place',), max_length=50, populate_from='title'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.slug'
        db.delete_column(u'organization_organization', 'slug')
