...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.sherlock_description'
        db.add_column(u'organization_organization', 'sherlock_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.sherlock_description'
        db.delete_column(u'organization_organization', 'sherlock_description')
