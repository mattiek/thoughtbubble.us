...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommentSupport'
        db.create_table(u'supportering_commentsupport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comments.Comment'])),
        ))
        db.send_create_signal(u'supportering', ['CommentSupport'])


    def backwards(self, orm):
        # Deleting model 'CommentSupport'
        db.delete_table(u'supportering_commentsupport')
    ...
    models = {
        ...
        u'comments.comment': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'comment_comments'", 'null': 'True', 'to': u"orm['thoughtbubble.ThoughtbubbleUser']"}),
        ...
        u'supportering.commentsupport': {
            'Meta': {'object_name': 'CommentSupport'},
