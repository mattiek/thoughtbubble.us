...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Idea.slug'
        db.alter_column(u'idea_idea', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=('content_object',), max_length=50, populate_from='name'))

    def backwards(self, orm):

        # Changing field 'Idea.slug'
        db.alter_column(u'idea_idea', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=('object_id',), populate_from='name'))
    ...
    models = {
        ...
        u'idea.idea': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 12, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': "('content_object',)", 'max_length': '50', 'populate_from': "'name'"}),
        ...
        u'idea.ideatype': {
            'Meta': {'ordering': "['ordering']", 'object_name': 'IdeaType'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
