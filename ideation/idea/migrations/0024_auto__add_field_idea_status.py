...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Idea.status'
        db.add_column(u'idea_idea', 'status',
                      self.gf('django.db.models.fields.CharField')(default='active', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Idea.status'
        db.delete_column(u'idea_idea', 'status')
    ...
    models = {
        ...
        u'idea.idea': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 9, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 9, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
