...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'idea_idea', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=('object_id',), max_length=50, populate_from='name'))

    def backwards(self, orm):

        # Changing field 'Idea.slug'
        db.alter_column(u'idea_idea', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=('content_object',), populate_from='name'))
    ...
    models = {
        ...
        u'idea.idea': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': "('object_id',)", 'max_length': '50', 'populate_from': "'name'"}),
