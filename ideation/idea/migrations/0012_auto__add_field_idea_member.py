...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Idea.member'
        db.add_column(u'idea_idea', 'member',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='member_idea_creator', null=True, to=orm['thoughtbubble.ThoughtbubbleUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Idea.member'
        db.delete_column(u'idea_idea', 'member_id')
    ...
    models = {
        ...
        u'idea.idea': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 30, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 30, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
