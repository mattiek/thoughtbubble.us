...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Idea.where'
        db.alter_column(u'idea_idea', 'where_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['location.Location']))

    def backwards(self, orm):

        # Changing field 'Idea.where'
        db.alter_column(u'idea_idea', 'where_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['neighborhood.Neighborhood']))
