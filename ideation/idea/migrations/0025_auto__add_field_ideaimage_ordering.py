...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IdeaImage.ordering'
        db.add_column(u'idea_ideaimage', 'ordering',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IdeaImage.ordering'
        db.delete_column(u'idea_ideaimage', 'ordering')
    ...
    models = {
        ...
        u'idea.idea': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 31, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 31, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
