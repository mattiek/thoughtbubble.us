...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Organization.neighborhood'
        db.delete_column(u'organization_organization', 'neighborhood_id')

        # Adding field 'Organization.city'
        db.add_column(u'organization_organization', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cities.City'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.geom'
        db.add_column(u'organization_organization', 'geom',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Organization.center'
        db.add_column(u'organization_organization', 'center',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Organization.neighborhood'
        raise RuntimeError("Cannot reverse this migration. 'Organization.neighborhood' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Organization.neighborhood'
        db.add_column(u'organization_organization', 'neighborhood',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['neighborhood.Neighborhood'], unique=True),
                      keep_default=False)

        # Deleting field 'Organization.city'
        db.delete_column(u'organization_organization', 'city_id')

        # Deleting field 'Organization.geom'
        db.delete_column(u'organization_organization', 'geom')

        # Deleting field 'Organization.center'
        db.delete_column(u'organization_organization', 'center')
