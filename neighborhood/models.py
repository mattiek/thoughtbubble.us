...
class Neighborhood(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('neighborhoods_detail', args=[str(self.state).lower(),str(self.city).lower(),str(self.id)])
    ...
    def getProperties(self):
        ...
        props['explore'] = reverse('sherlock', args=[str(self.state).lower(),str(self.city).lower(),str(self.id)])
