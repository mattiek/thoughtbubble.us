...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Community.date_created'
        db.add_column(u'community_community', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 2, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Community.date_modified'
        db.add_column(u'community_community', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 2, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Community.date_created'
        db.delete_column(u'community_community', 'date_created')

        # Deleting field 'Community.date_modified'
        db.delete_column(u'community_community', 'date_modified')
