...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommunityImage'
        db.create_table(u'community_communityimage', (
        ...
        db.send_create_signal(u'community', ['CommunityImage'])


    def backwards(self, orm):
        # Deleting model 'CommunityImage'
        db.delete_table(u'community_communityimage')
