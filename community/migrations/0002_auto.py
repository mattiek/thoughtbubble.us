...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'community_community_members')
        ...
        db.create_unique(m2m_table_name, ['community_id', 'thoughtbubbleuser_id'])


    def backwards(self, orm):
        # Removing M2M table for field members on 'Community'
        db.delete_table(db.shorten_name(u'community_community_members'))
