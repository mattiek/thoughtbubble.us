...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IdeaLink.url'
        db.alter_column(u'idea_idealink', 'url', self.gf('django.db.models.fields.CharField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'IdeaLink.url'
        db.alter_column(u'idea_idealink', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        u'idea.idea': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 15, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
