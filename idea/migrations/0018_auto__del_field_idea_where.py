...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Idea.where'
        db.delete_column(u'idea_idea', 'where_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Idea.where'
        raise RuntimeError("Cannot reverse this migration. 'Idea.where' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Idea.where'
        db.add_column(u'idea_idea', 'where',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['location.Location']),
                      keep_default=False)
