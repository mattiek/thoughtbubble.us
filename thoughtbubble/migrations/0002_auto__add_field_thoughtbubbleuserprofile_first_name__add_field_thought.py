...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ThoughtbubbleUserProfile.first_name'
        db.add_column(u'thoughtbubble_thoughtbubbleuserprofile', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ThoughtbubbleUserProfile.last_name'
        db.add_column(u'thoughtbubble_thoughtbubbleuserprofile', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ThoughtbubbleUserProfile.first_name'
        db.delete_column(u'thoughtbubble_thoughtbubbleuserprofile', 'first_name')

        # Deleting field 'ThoughtbubbleUserProfile.last_name'
        db.delete_column(u'thoughtbubble_thoughtbubbleuserprofile', 'last_name')
